    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 min-h-screen">
      ...
      {isLoading ? (
        <div className="py-24 flex flex-col items-center justify-center text-center space-y-3">
          ...
          <p className="text-xs font-mono text-neutral-400">AniList ve Arşiv verileri yükleniyor...</p>
        </div>
      ) : (
        <div className="space-y-6">

          {/* AniList Banner Image Header (if available) */}
          {info?.Banner && (
            <div className="relative w-full h-48 sm:h-64 rounded-xl overflow-hidden border border-[#262626] shadow-2xl">
              <img
                src={info.Banner}
                alt={`${animeTitle} Banner`}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
            ...
            {/* Left Column: AniList Poster Image & Quick Info */}
            <div className="lg:col-span-1 space-y-4">
              <div className="relative aspect-[3/4] w-full rounded-lg overflow-hidden border border-[#262626] bg-[#0a0a0a] shadow-xl">
                {info?.Resim ? (
                  <img
                    src={info.Resim}
                    alt={animeTitle}
